...
<head>
  ...
  <meta name="google-site-verification" content="f-PkKkDuFin68InkhbmcUR8b_a-ZD4sKIoUe4CqY7IU" />
  ...
  <meta name="keywords" content="Adane Nega Tarekegn, AdaneNT, GitHub, cluster-validity-csai, AI, Data Science, Machine Learning, Multimodal AI, Deep Learning, Computer Vision, Research, CSAI, Cluster Validation, Clustering Stability, Python Package, Unsupervised Learning, Adane Tarekegn, AI Tools">
  ...
  <meta property="og:image" content="https://adanent.github.io/images/ad200.jpg"> <!-- optional, update to full image URL -->
  ...
  <nav class="nav-menu">
    ...
    <table>
        ...
        <td width="200px" valign="top" style="text-align: center; font-family: Arial, sans-serif; padding-right: 40px;">
            ...
            <img src="images/ad_self.jpg" width="140" style="border-radius: 50%; border: 4px solid #f0f0f0;" alt="Adane N. Tarekegn" />
          <div style="font-size: 16px; font-weight: bold; margin-top: 15px; margin-bottom: 5px; white-space: nowrap;"> Adane N. Tarekegn
            ...
            <li style="margin-bottom: 20px; display: flex; align-items: center;">
              <img src="https://cdn-icons-png.flaticon.com/512/535/535239.png" alt="Location" style="height: 18px; width: 18px; margin-right: 8px; filter: grayscale(100%) brightness(0);">
...
<h3 id="about">About me</h3>
 <p>I’m Adane, an AI researcher working at the intersection of machine learning, generative AI, and multimodal learning, with applications in pattern recognition, data analysis, and decision-making.</p>  

<p style="text-align: justify;">
My work focuses on building intelligent systems that can solve complex tasks. Currently, I am a postdoctoral researcher at <a href="https://mediafutures.no/">SFI MediaFutures </a> (University of Bergen, Norway), where I work on multimodal AI, LLMs, and deep generative models for real-world industry applications. 
</p>  
...
<ul>
 ...
 <hr>
            <h3 id="teaching">Teaching & Mentorship</h3>
                <ul>
                <li>MSc: <em>Deep Learning & Computer Vision</em> – University of Wollo</li>
                <li>BSc (Seminar Leader):<em>AI Ethics</em> – University of Bergen</li>
               <li>BSc/MSc:<em>Machine Learning</em>, <em>Programming</em>, <em>Human-Computer Interaction (HCI)</em> – Bahir Dar University</li>
                <li><strong>Thesis Supervision:</strong> Machine Learning, Deep Learning, and Data Science projects, </li>
                </ul>
            </td>
        </tr>
    </table>
